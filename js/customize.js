...
(function () {
  ...
  const mySwiper = new Swiper('.mySlider .swiper', {
    loop: true,
    effect: 'coverflow',
    grabCursor: true,
    centeredSlides: true,
    ...
    // 切換箭頭
    navigation: {
      nextEl: '.mySlider .nextSlider', //自行設定樣式
      prevEl: '.mySlider .prevSlider', //自行設定樣式
      disabledClass: '.mySlider swiperArrow-disabled', //不可點選樣式
    },
    breakpoints: {
      100: {
        slidesPerView: 2,
